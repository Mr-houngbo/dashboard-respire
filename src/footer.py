    ...
    <body>
        <div class="footer-container">
            <div class="footer-header">
                ...
                <div class="footer-tagline">🌬️ Dashboard de qualité de l'air dans les écoles 🏫</div>
            </div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-card">
                    ...
                    <div class="card-content">
                        ...
                        📁 <a href="https://github.com/dashboard-respire" target="_blank" class="footer-link">Code source GitHub</a><br><br>
                        🏷️ Version <strong>1.0.0</strong>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                © 2025 RESPiRE Project • Développé avec ❤️ pour un air plus pur
            </div>
        </div>
    </body>
    </html>
